...
namespace AGDDPlatformer
{
    public class PlayerController : KinematicObject
    {
        ...
        public void setInZone(bool val)
        {
            inZone = val;
        }
        ...
        private void Bounce()
        {
            velocity.y = Mathf.Sign(gravityModifier) * bounceHeight;        
        }
        ...
        private void OnCollisionEnter2D(Collision2D other) 
        {
            ...
            else if (other.gameObject.tag == "GreenBlock")
            {
                Bounce();
            }
